...
{
    public static MyCSVReader Instance = null;
    ...
    public void Initialize(string fileName)
    {
        ...
        for (int i = 1; i < 5; i++)
        {
            ...
            //    IntParse(chars[5]), (ItemType)Enum.Parse(typeof(ItemType), chars[6]), IntParse(chars[7]),
            //    (ItemSource)Enum.Parse(typeof(ItemSource), chars[8]), IntParse(chars[9]), IntParse(chars[10]),
            //    IntParse(chars[11]), IntParse(chars[12]), IntParse(chars[13]), IntParse(chars[14]),
            //    IntParse(chars[15]), IntParse(chars[16]), IntParse(chars[17]));
        }
    }
