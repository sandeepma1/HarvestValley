...
public class BuildingsManager : MonoBehaviour
{
    ...
    private void OneTimeOnly()
    {
        if (PlayerPrefs.GetInt("firstBuilding") <= 0)
        {
            ...
            buildings.Add(new Buildings(1, 0, "Field", new Vector2(2, 0), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(2, 0, "Field", new Vector2(4, 0), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(3, 0, "Field", new Vector2(6, 0), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(4, 0, "Field", new Vector2(0, -2), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(5, 0, "Field", new Vector2(2, -2), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(6, 0, "Field", new Vector2(4, -2), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(7, 0, "Field", new Vector2(6, -2), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(8, 0, "Field", new Vector2(0, -4), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(9, 0, "Field", new Vector2(2, -4), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(10, 0, "Field", new Vector2(4, -4), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(11, 0, "Field", new Vector2(6, -4), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(12, 0, "Field", new Vector2(0, -6), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(13, 0, "Field", new Vector2(2, -6), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(14, 0, "Field", new Vector2(4, -6), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            buildings.Add(new Buildings(15, 0, "Field", new Vector2(6, -6), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
