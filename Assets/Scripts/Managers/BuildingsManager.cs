...
public class BuildingsManager : MonoBehaviour
{
    ...
    private void OneTimeOnly()
    {
        if (PlayerPrefs.GetInt("firstBuilding") <= 0)
        {
            ...
            buildings.Add(new Buildings(2, 0, "Field", new Vector2(12, 0), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            ...
            buildings.Add(new Buildings(2, 0, "Field", new Vector2(12, -4), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            ...
            buildings.Add(new Buildings(2, 0, "Field", new Vector2(12, -8), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
            ...
            buildings.Add(new Buildings(2, 0, "Field", new Vector2(12, -12), 1, 0, 0, -1, System.DateTime.UtcNow.ToString()));
